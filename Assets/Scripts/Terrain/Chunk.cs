...
public class Chunk
{
    ...
    {
        m_Blocks = new Block[m_WorldData.ChunkBlockWidth, m_WorldData.ChunkBlockHeight, m_WorldData.ChunkBlockDepth];
    }
    ...
    public void ReInitialize(Vector3i location)
    {
        ...
        ArrayZ = location.Z;
        Id++;
        m_WorldData.Chunks[location.X, location.Y, location.Z] = this;
        InitializeBlocks();
    }
    ...
    public int ArrayX
    {
        ...
        {
            m_ArrayX = value;
            m_Position.X = value * m_WorldData.ChunkBlockWidth + m_WorldData.MapChunkOffset.X * m_WorldData.ChunkBlockWidth;
        }
    }
    ...
    public int ArrayY
    {
        ...
        {
            m_ArrayY = value;
            m_Position.Y = value * m_WorldData.ChunkBlockHeight + m_WorldData.MapChunkOffset.Y * m_WorldData.ChunkBlockHeight;
        }
    }
    ...
    public int ArrayZ
    {
        ...
        {
            m_ArrayZ = value;
            m_Position.Z = value + (m_WorldData.MapChunkOffset.Z * m_WorldData.ChunkBlockDepth);
        }
    }

    public Vector3i WorldPosition
    {
        get { return new Vector3i(m_ArrayX + m_WorldData.MapChunkOffset.X, m_ArrayY + m_WorldData.MapChunkOffset.Y, m_ArrayZ); }
    }
    ...
    public bool IsOnTheBorder
    {
        get
        {
            return m_ArrayX == 0 || m_ArrayY == 0 || m_ArrayX == m_WorldData.RightChunkBorderColumn ||
                   m_ArrayY == m_WorldData.TopChunkBorderRow ;
        }
    }
